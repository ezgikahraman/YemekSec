...
$kategori=$_GET['yemek_kategori'];
$yemeksor=$db->prepare("SELECT * FROM yemekler where yemek_kategori=:kategori");
...
<div class="container">
			...
			<div class="sonucx" >
				...
				<center><h1 style="font-size: 85px;font-weight: bold;color:#698b69"><?php 
